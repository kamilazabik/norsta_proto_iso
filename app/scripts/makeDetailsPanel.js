function makeButtonExpand(numberOfChildMainPanel, j){
  var panelRowCol6Row1 = $('<div class="row"></div>')
    ...
    ,panelRowCol6Button = $('<button type=\'button\' name=\'expand\' class=\' btn btn-sm custom-btn expand-main-page btn-expand-panel\' data-label=\'' + numberOfChildMainPanel[j - 1] + '\'>Expand</button>');
...
function makeButtonsOpenDetailsAddEvid(numberOfChildMainPanel, j,className, hiddenClass){
  var numberOfChild = numberOfChildMainPanel[j - 1]
    ...
    , buttonExpandPanelHidden = $('<button type=\'button\' class=\' hidden-lg hidden-xl btn btn-expand ' + numberOfChild + '\' data-toggle=\'collapse\' aria-expanded=\'false\'  name=\'openPanelDetails\' data-target=\'#collapsePanelDetails' + numberOfChild + '\' aria-controls=\'collapsePanelDetails' + numberOfChild + '\' title=\'Show details panel\' data-expand=\''+ numberOfChild+'\'></button>')
    , buttonExpandPanelNotHidden = $('<button type=\'button\' class=\'btn btn-expand ' + numberOfChild + '\' data-toggle=\'collapse\' aria-expanded=\'false\'  name=\'openPanelDetails\' data-target=\'#collapsePanelDetails' + numberOfChild + '\' aria-controls=\'collapsePanelDetails' + numberOfChild + '\' title=\'Show details panel\'  data-expand=\''+ numberOfChild+'\'></button>')
    , buttonAddFirstEvidence = $('<button type=\'button\' class=\'btn btn-add ' + numberOfChild+' pull-right\' data-toggle=\'tooltip\' data-placement=\'top\' title=\'Upload New Evidence\' name=\'' + numberOfChild + '\'  data-add=\''+ numberOfChild+'\'></button>').append ('<i class="fa fa-plus" aria-hidden="true"></i>');
...
function makeDetailsPanel(numberOfChildMainPanel, j){
  var tabPanels = $('<div id =\'tabsPanels' +numberOfChildMainPanel[j - 1]+ '\' class=\'panel-block__evidences-details\'></div>')
    ...
    , tabPanelsColUlLi1a = $('<a href=\'#assessment' +numberOfChildMainPanel[j - 1]+ '\' data-toggle=\'tab\'>Assessment</a>')
    ...
    , tabContentAssessRowColH = $('<p class=\'comment\'></p>').text('Description')
  ...
  var tabContentDetailsRow1Col1H = $('<h5 class="hidden-xs"></h5>').text('Name')
    ...
    , tabContentDetailsRow4Col1H = $('<h5></h5>').text('Description')
