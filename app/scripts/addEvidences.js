...
function makeTr(className, rowCount ){
  var evidenceTr3 = $('<tr class=\'' + rowCount +'\'></tr>')
    , evidenceTr3Td1 = $('<th class="evidences-table-tbody__th"></th>').text(rowCount)
    , evidenceTr3Td2 = $('<td class="nameEvidence evidences-table-tbody__td"></td>').text(isoObject[className]['nameEvidence' + rowCount])

    , evidenceTr3Td3 = $('<td class="evidences-table-tbody__td"></td>')
    , evidenceTr3Td4 = $('<td class="nameDocument evidences-table-tbody__td"></td>').text(isoObject[className]['nameDocument' + rowCount])
    , evidenceTr3Td5 = $('<td class="evidences-table-tbody__td evidences-table-tbody__td--buttons"></td>')
